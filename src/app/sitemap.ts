...
const STATIC_ROUTES = [
  ...
  { path: "/roast", priority: 0.9, changeFrequency: "daily" as const },
  { path: "/manifesto", priority: 0.5, changeFrequency: "monthly" as const },
  { path: "/top-funds", priority: 0.8, changeFrequency: "daily" as const },
  { path: "/elss-tax-saver", priority: 0.9, changeFrequency: "daily" as const },
  { path: "/bambaibhada", priority: 0.95, changeFrequency: "daily" as const },
  { path: "/bambaibhada?city=mumbai", priority: 0.9, changeFrequency: "daily" as const },
  { path: "/bambaibhada?city=bangalore", priority: 0.9, changeFrequency: "daily" as const },
  { path: "/bambaibhada?city=gurgaon", priority: 0.9, changeFrequency: "daily" as const },
