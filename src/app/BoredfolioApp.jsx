...
function Navbar(p) {
  ...
  return e("div",null,
    e("nav",{style:{position:"fixed",top:0,left:0,right:0,zIndex:1000,padding:sc?"12px 28px":"20px 28px",background:sc?"rgba(245,240,232,0.92)":"transparent",backdropFilter:sc?"blur(30px)":"none",WebkitBackdropFilter:sc?"blur(30px)":"none",borderBottom:sc?"1px solid "+C.border:"1px solid transparent",transition:"all 0.4s",display:"flex",justifyContent:"space-between",alignItems:"center"}},
      ...
      m ? e("div",{onClick:function(){smo(!mo);},style:{fontFamily:Mf,fontSize:10,fontWeight:700,color:C.char,cursor:"pointer",letterSpacing:2}},mo?"CLOSE":"MENU")
        : e("div",{style:{display:"flex",alignItems:"center",gap:28}},
            ...
            e("a",{href:"/sarvam",style:{fontFamily:Bf,fontSize:13,color:C.mustard,cursor:"pointer",fontWeight:600,textDecoration:"none"}},"Hindi Roast 🔊"),
    ...
    m&&mo ? e("div",{style:{position:"fixed",inset:0,background:C.cream,zIndex:999,padding:"100px 28px",animation:"fadeIn 0.3s ease"}},
      ["Explore","Learn","Calculator","Roast 🔥","Hindi Roast 🔊","Manifesto"].map(function(t){var lbl=t.replace(" 🔥","").replace(" 🔊","");return e("div",{key:t,onClick:function(){if(lbl==="Roast"){window.location.href="/roast";}else if(lbl==="Hindi Roast"){window.location.href="/sarvam";}else{go("/"+lbl.toLowerCase());}},style:{fontFamily:Sf,fontSize:36,color:lbl==="Roast"?C.red:lbl==="Hindi Roast"?C.mustard:C.char,padding:"18px 0",borderBottom:"1px solid "+C.border,cursor:"pointer"}},t);})
    ) : null
  );
}
  ...
  return e("section",{ref:ref,style:{padding:m?"72px 0":"120px 0",background:C.sage}},
    e(Wrap,{style:{maxWidth:660,textAlign:"center"}},
      ...
      e(A,{vis:vis,delay:0.3},e("div",{style:{display:"flex",gap:12,justifyContent:"center",flexWrap:"wrap"}},
        ...
        e("a",{href:"/roast",style:{fontFamily:Bf,fontSize:14,fontWeight:700,color:C.cream,background:C.red,border:"none",padding:"14px 32px",borderRadius:8,cursor:"pointer",textDecoration:"none",display:"inline-block"}},"🔥 Roast your fund"),
        e("a",{href:"/sarvam",style:{fontFamily:Bf,fontSize:14,fontWeight:700,color:C.cream,background:C.mustard,border:"none",padding:"14px 32px",borderRadius:8,cursor:"pointer",textDecoration:"none",display:"inline-block"}},"🔊 Hindi audio roast"),
