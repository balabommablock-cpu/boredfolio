...
function Navbar(p) {
  ...
  return e("div",null,
    e("nav",{style:{position:"fixed",top:0,left:0,right:0,zIndex:1000,padding:sc?"12px 28px":"20px 28px",background:sc?"rgba(245,240,232,0.92)":"transparent",backdropFilter:sc?"blur(30px)":"none",WebkitBackdropFilter:sc?"blur(30px)":"none",borderBottom:sc?"1px solid "+C.border:"1px solid transparent",transition:"all 0.4s",display:"flex",justifyContent:"space-between",alignItems:"center"}},
      ...
      m ? e("div",{onClick:function(){smo(!mo);},style:{fontFamily:Mf,fontSize:10,fontWeight:700,color:C.char,cursor:"pointer",letterSpacing:2}},mo?"CLOSE":"MENU")
        : e("div",{style:{display:"flex",alignItems:"center",gap:28}},
            ...
            e("a",{href:"/agdambagdam",style:{fontFamily:Bf,fontSize:13,color:"#4F46E5",cursor:"pointer",fontWeight:600,textDecoration:"none"}},"A/B Test"),
    ...
    m&&mo ? e("div",{style:{position:"fixed",inset:0,background:C.cream,zIndex:999,padding:"100px 28px",animation:"fadeIn 0.3s ease"}},
      ["Explore","Learn","Calculator","Roast 🔥","A/B Test","Manifesto"].map(function(t){var lbl=t.replace(" 🔥","");return e("div",{key:t,onClick:function(){if(lbl==="Roast"){window.location.href="/roast";}else if(lbl==="A/B Test"){window.location.href="/agdambagdam";}else{go("/"+lbl.toLowerCase());}},style:{fontFamily:Sf,fontSize:36,color:lbl==="Roast"?C.red:lbl==="A/B Test"?"#4F46E5":C.char,padding:"18px 0",borderBottom:"1px solid "+C.border,cursor:"pointer"}},t);})
    ) : null
  );
}
      ...
      e("div",{style:{display:"flex",justifyContent:"space-between",flexWrap:"wrap",gap:20,marginBottom:28}},
        ...
        e("div",{style:{display:"flex",gap:m?24:40,flexWrap:"wrap"}},
          ...
          e("div",null,
            ...
            ["Roast Your Fund|/roast","A/B Testing|/agdambagdam","Calculator|/calculator","Direct vs Regular|/direct-vs-regular","Manifesto|/manifesto","Rankings|/top-funds"].map(function(x){var p=x.split("|"); return e("div",{key:p[1],onClick:function(){go(p[1]);},style:{fontFamily:Bf,fontSize:13,color:C.muted,marginBottom:8,cursor:"pointer",padding:"2px 0"}},p[0]);})
          )
        )
      ),
